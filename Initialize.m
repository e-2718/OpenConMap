function verticesZ=Initialize(F,starting_point,verticesN)
N1=length(F);
...
X=[starting_point,starting_point(1)];
...
z=[z,z(1)];
%%
NN1=round(r./sum(r)*(verticesN-N1));
NN2=r./(NN1+1);
verticesZ=[];

for k1=1:N1
    
    verticesZ=[verticesZ,X(k1)];
