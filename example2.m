...
%%
[C,err]=ConformalSolve(z_V,2000,500,4000,0.6,1e-4);

omegau=C(end:-1:1).';
omegad=[1 0].';
%%
[rho,theta]=meshgrid(linspace(0.1,1,20),linspace(0,2*pi,10000));
zeta1=rho.*exp(i*theta);
z1=(polyval(omegau,zeta1)./(polyval(omegad,zeta1)));

[rho,theta]=meshgrid(linspace(0,1,1000),linspace(0,2*pi,100));
